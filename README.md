...
- **AWS Hackathon 2026** - Submitted for Social Impact Category
- **Target**: Top 3 in India region for AI/ML innovation
- **Focus**: Preventing justice debt traps through technology

---

## 📞 Contact & Support

- **Team Lead**: [Your Name](mailto:your.email@domain.com)
- **Project Repository**: [GitHub](https://github.com/your-org/nyaya-mitra)
- **Documentation**: [Wiki](https://github.com/your-org/nyaya-mitra/wiki)
- **Issues**: [GitHub Issues](https://github.com/your-org/nyaya-mitra/issues)

---

## 🙏 Acknowledgments

- **Inspiration**: Rural families fighting legal battles without proper guidance
- **Data Sources**: Public legal precedents, RTI-obtained court records
- **Technology**: AWS AI/ML services enabling voice-first accessibility
- **Community**: Legal aid organizations providing domain expertise
...
- [x] Basic voice interface (Hindi/English)
- [x] Simple cost calculator
...
**Made with ❤️ for rural India's access to justice**

*NYAYA MITRA - Preventing justice debt traps, one voice call at a time.*